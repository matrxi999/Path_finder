    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_d and complete == True:
                    while close == False:
                        text1 = 'The shortest path was:'
                        text2 = str(dlugosc-1) + ' steps long'
                        text6 = '        '
                        text7 = 'Close'
                        ...
                        if pygame.mouse.get_pressed()[0]:
                            pos = pygame.mouse.get_pos()
                            x, y = pos
                            if x in range(344, 455) and y in range(375, 425):
                                close = True
